package com.funguide.cc.movieticket.expandtabview;
...
//				LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(2, LayoutParams.WRAP_CONTENT);
				LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(2,50);
				addView(line, lp);
			}
